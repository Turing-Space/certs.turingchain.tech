      ...
      <AnimatedWrapper animateIn="fadeInUp" animateOnce delay={300}>
        ...
        <Paragraph>
          ...
          <StyledDescription>
            ...
            <br />
            ● 蒐集來源 <br />
            使用Turing Chain 區塊鏈履歷服務之發證方(本公司為資料處理者) <br />
            本公司 <br />
            ● 本公司服務 <br />
            Turing Chain 區塊鏈履歷服務 <br />
            使用Turing Chain 區塊鏈履歷服務之發證方與本公司簽訂合約 <br />
            網站 <br />
            ● 法定特定目的 <br />
            1. 119 發照與登記 <br />
            2. 154 徵信 <br />
            3. C102 約定或契約 <br />
            4. 152 廣告或商業行為管理 <br />
            5. 090 消費者、客戶管理與服務 <br />
            6. 040 行銷（包含金控共同行銷業務） <br />
            7. 157 調查、統計與研究分析 <br />
            8. 148 網路購物及其他電子商務服務 <br />
            ● 蒐集個資 <br />
            I. 姓名、電子郵遞地址、行動電話、地址； <br />
            ii. 身分證字號； <br />
            iii. 證照號碼； <br />
            iv. 學號、學校、成績； <br />
            v. 任職公司； <br />
            vi. 不動產資訊； <br />
            vii. 電子郵遞地址、電話號碼、機構名稱； <br />
            viii. cookies <br />
            ● 法定個資類別 <br />
            1. C001 辨識個人者 <br />
            2. C003 政府資料中之辨識者 <br />
